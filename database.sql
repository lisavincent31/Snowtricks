...
INSERT INTO users (id, username, roles, email, password, is_verified, avatar, created_at) VALUES 
    (1, 'Admin', '["ROLE_USER", "ROLE_ADMIN"]', 'admin@mailinator.com', 'admin1234', 0, 'default-profil1.jpg', '2024-02-29'),
    (2, 'emily_grld', '["ROLE_USER"]', 'emily_grld@mailinator.com', 'emily_grld', 0, 'default-profil2.jpg', '2024-02-29'),
    (3, 'john_prorider', '["ROLE_USER"]', 'john_prorider@mailinator.com', 'john_prorider', 0, 'default-profil3.jpg', '2024-02-29'),
    (4, 'michel_richardson', '["ROLE_USER"]', 'michel_richardson@mailinator.com', 'michel_richardson', 0, 'default-profil4.jpg', '2024-02-29'),
    (5, 'smithy', '["ROLE_USER"]', 'smithy@mailinator.com', 'smithy', 0, 'default-profil5.jpg', '2024-02-29'),
    (6, 'lisa_vncnt', '["ROLE_USER"]', 'lisa_vncnt@mailinator.com', 'lisa_vncnt', 0, 'default-profil6.jpg', '2024-02-29'),
    (7, 'mr_snow', '["ROLE_USER"]', 'mr_snow@mailinator.com', 'mr_snow', 0, 'default-profil7.jpg', '2024-02-29'),
    (8, 'alicia_stn', '["ROLE_USER"]', 'alicia_stn@mailinator.com', 'alicia_stn', 0, 'default-profil8.jpg', '2024-02-29'),
    (9, 'miranda_carls', '["ROLE_USER"]', 'miranda_carls@mailinator.com', 'miranda_carls', 0, 'default-profil9.jpeg', '2024-02-29'),
    (10, 'patrick', '["ROLE_USER"]', 'patrick@mailinator.com', 'patrick', 0, 'default-profil10.jpeg', '2024-02-29')
;
...
INSERT INTO media (id, trick_id, name, url, type, created_at, updated_at) VALUES 
    (1, 1, 'stalefish.jpg', '../public/assets/medias/tricks/stalefish.jpg', 'image', '2024-03-02', '2024-03-02'),
    (2, 1, 'stalefish-2.webp', '../public/assets/medias/tricks/stalefish-2.webp', 'image', '2024-03-02','2024-03-02'),
    (3, 1, 'stalefish-3.jpg', '../public/assets/medias/tricks/stalefish-3.jpg', 'image', '2024-03-02', '2024-03-02'),
    (4, 2, 'frontside_boardslide.webp', '../public/assets/medias/tricks/frontside_boardslide.webp', 'image', '2024-03-03', '2024-03-03'),
    (5, 2, 'frontside_boardslide_2.jpg', '../public/assets/medias/tricks/frontside_boardslide_2.jpg', 'image', '2024-03-03', '2024-03-03'),
    (6, 3, 'tripod.jpg', '../public/assets/medias/tricks/tripod.jpg', 'image', '2024-03-04', '2024-03-04'),
    (7, 3, 'tripod_2.avif', '../public/assets/medias/tricks/tripod_2.avif', 'image', '2024-03-04', '2024-03-04'),
    (8, 3, 'tripod_3.jpg', '../public/assets/medias/tricks/tripod_3.jpg', 'image', '2024-03-04', '2024-03-04'),
    (9, 4, '5050.jpg', '../public/assets/medias/tricks/5050.jpg', 'image', '2024-03-05', '2024-03-05'),
    (10, 4, '5050_2.webp', '../public/assets/medias/tricks/5050_2.webp', 'image', '2024-03-05', '2024-03-05'),
    (11, 4, '5050_3.jpg', '../public/assets/medias/tricks/5050_3.jpg', 'image', '2024-03-05', '2024-03-05'),
    (12, 4, '5050_4.jpg', '../public/assets/medias/tricks/5050_4.jpg', 'image', '2024-03-05', '2024-03-05'),
    (13, 4, 'frontside_lipslide.webp', '../public/assets/medias/tricks/frontside_lipslide.webp', 'image', '2024-03-05', '2024-03-05'),
    (14, 4, 'frontside_lipslide_2.jpg', '../public/assets/medias/tricks/frontside_lipslide_2.jpg', 'image', '2024-03-05', '2024-03-05'),
    (15, 5, 'backflip.webp', '../public/assets/medias/tricks/backflip.webp', 'image', '2024-03-06', '2024-03-06'),
    (16, 6, 'backside-360.jpg', '../public/assets/medias/tricks/backside-360.jpg', 'image', '2024-03-07', '2024-03-07'),
    (17, 6, 'backside-360-2.jpg', '../public/assets/medias/tricks/backside-360.jpg-2', 'image', '2024-03-07', '2024-03-07'),
    (18, 6, 'backside-360-3.jpg', '../public/assets/medias/tricks/backside-360-3.jpg', 'image', '2024-03-07', '2024-03-07'),
    (19, 7, 'method_grab.jpg', '../public/assets/medias/tricks/method_grab.jpg', 'image', '2024-03-08', '2024-03-08'),
    (20, 7, 'method_grab_2.jpg', '../public/assets/medias/tricks/method_grab_2.jpg', 'image', '2024-03-08', '2024-03-08'),
    (21, 7, 'method_grab_3.jpg', '../public/assets/medias/tricks/method_grab_3.jpg', 'image', '2024-03-08', '2024-03-08'),
    (22, 8, 'melon_grab.jpg', '../public/assets/medias/tricks/melon_grab.jpg', 'image', '2024-03-09', '2024-03-09'),
    (23, 8, 'melon_grab_2.jpg', '../public/assets/medias/tricks/melon_grab_2.jpg', 'image', '2024-03-09', '2024-03-09'),
    (24, 8, 'melon_grab_3.jpg', '../public/assets/medias/tricks/melon_grab_3.jpg', 'image', '2024-03-09', '2024-03-09'),
    (25, 9, 'indy_grab.jpg', '../public/assets/medias/tricks/indy_grab.jpg', 'image', '2024-03-10', '2024-03-10'),
    (26, 9, 'indy_grab_2.jpg', '../public/assets/medias/tricks/indy_grab2_.jpg', 'image', '2024-03-10', '2024-03-10'),
    (27, 9, 'indy_grab_3.jpg', '../public/assets/medias/tricks/indy_grab_3.jpg', 'image', '2024-03-10', '2024-03-10'),
    (28, 10, '360_tail_grab.webp', '../public/assets/medias/tricks/360_tail_grab.webp', 'image', '2024-03-11', '2024-03-11'),
    (29, 10, '360_tail_grab_2.jpg', '../public/assets/medias/tricks/360_tail_grab_2.jpg', 'image', '2024-03-11', '2024-03-11')
;